...
| Recovery Time Objective (RTO) | 24時間以内に完了する仕様となっております。<br> **大容量の VM では復元に 24 時間以上かかる場合がございます。**<br>・[ご参考]1.1 Azure VM Backup のバックアップ時間について　Azure Backup の バックアップ / リストア 所要時間について　<br>https://jpabrs-scem.github.io/blog/RecoveryServicesVaults/Backup_RecoveryTIme/#1-1 | 2 時間以内の RTO を提供します。 |
...
## <a id="3"></a> 3. 参考情報 : DR 大作のための Azure VM のディスクの冗長構成は非推奨
