...
#version:1.4
#Copyright:tatsumiyamamoto, hidetakaono
...
URL_V2A[1]=login.windows.net
URL_V2A[2]=aadcdn.msftauth.net
URL_V2A[3]=aadcdn.msauth.net
URL_V2A[4]=download.microsoft.com
URL_V2A[5]=login.live.com
URL_V2A[6]=config.office.com
URL_V2A[7]=login.microsoftonline.com
URL_V2A[8]=secure.aadcdn.microsoftonline-p.com
URL_V2A[9]=autologon.microsoftazuread-sso.com
URL_V2A[10]=management.azure.com
URL_V2A[11]=dc.services.visualstudio.com
URL_V2A[12]=aka.ms
URL_V2A[13]=download.microsoft.com
URL_V2A[14]=prod.cus.discoverysrv.windowsazure.com
URL_V2A[15]=pod01-tel1.jpw.prod.migration.windowsazure.com
URL_V2A[16]=pod01-srs1.jpw.hypervrecoverymanager.windowsazure.com
